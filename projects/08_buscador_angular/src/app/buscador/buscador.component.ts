...
export class BuscadorComponent {
  ...
  //se ejecuta al seleccionar una tematica
  obtenerResultados():void{
    //si la tematica seleccionada es Todos no aplicamos filtro

    this.resultados=this.datos.filter((p=>p.tematica==this.tematicaSeleccionada));
}
